...
def main():
    ...
    for currentStudent in studentIDs:
        ...
        #Task 6
        file.write("<!-- TASK 6--><br /><br /><br /><br /><br /><br /><br /><br /><br /><div id='task6'><h3 style='color:red'>Task 6 (6.25 marks)</h3><p>Make the following assumptions in relation to the assignment scenario:</p><div id='q6'>" + RandomList(ql.q6list) + "</div></div><hr>")
